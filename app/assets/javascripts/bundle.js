...
/***/ function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } //test@test.com
	//12345678

	var mockTweets = [{ id: 1, name: 'Samer Buna', body: 'My Tweet' }, { id: 2, name: 'Samer Buna', body: 'My 1st Tweet' }, { id: 3, name: 'Samer Buna', body: 'My 2nd Tweet' }];
	  ...
	  _createClass(Main, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      $.ajax("/tweets").success(function (data) {
	        console.log(data);
	        _this3.setState(_this3.formattedTweets(data));
	      }).error(function (err) {
	        return console.log(err);
	      });
	    }
